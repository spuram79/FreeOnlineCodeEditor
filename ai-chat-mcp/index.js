 ...
 * Supports both stdio (for local clients like Claude Desktop) and HTTP/SSE transport
 * (for remote clients like VSCode).
 * 
...
// HTTP/SSE transport (for remote clients like VSCode)
async function runHttp() {
  ...
  app.get("/health", (req, res) => {
    res.json({ status: "ok", service: "ai-chat-mcp" });
  });
  ...
  app.listen(PORT, () => {
    console.error(`AI Chat MCP Server running on HTTP port ${PORT}`);
